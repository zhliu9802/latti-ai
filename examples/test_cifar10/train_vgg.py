...
from examples.test_cifar10.model import vgg16_bn
from examples.test_cifar10.model import vgg19_bn
from examples.test_cifar10.model import vgg11_bn
...
def main():
    parser = argparse.ArgumentParser(description='Train VGG16-BN on CIFAR-10')
    ...
    input_shape = args.input_shape or [3, 32, 32]
    train_loader, test_loader = get_cifar10_loaders(args.data_dir, args.batch_size, args.num_workers, input_shape)
